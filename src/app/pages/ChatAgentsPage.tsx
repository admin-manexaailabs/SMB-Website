...
export default function ChatAgentsPage() {
  ...
  const faqs = [
    {
      ...
      answer:
        "A Chat Agent is an AI-powered conversational assistant that can handle customer inquiries, bookings, lead capture, and support requests 24/7 across multiple channels like WhatsApp, SMS, email, and web chat — all without requiring any coding.",
    },
    {
      question: "How does it improve customer support?",
      answer:
        "Chat Agents provide instant responses to customer questions, reducing wait times from hours to seconds. They can handle multiple conversations simultaneously, qualify leads, book appointments, and escalate complex issues to human agents when needed.",
    },
    {
      question: "Which channels are supported?",
      answer:
        "Chat Agents work seamlessly across WhatsApp Business, SMS, Email, Instagram DMs, Facebook Messenger, and Web Chat widgets. You can deploy the same agent to all channels or customize behavior per channel.",
    },
    {
      question: "Is coding required?",
      answer:
        "No coding required! Our visual no-code builder lets you create chat agents by dragging and dropping conversation flows, setting up triggers, and customizing responses through an intuitive interface.",
    },
    {
      question: "Can I customize responses?",
      answer:
        "Absolutely! You can customize every aspect of your chat agent including personality, tone, response templates, conditional logic, and integration with your business data and systems.",
    },
    {
      question: "How quickly can I deploy a chat agent?",
      answer:
        "With our pre-built templates, you can have a fully functional chat agent live in under 10 minutes. Custom agents typically take 30-60 minutes depending on complexity.",
    },
  ];
  ...
  const demoMessages = [
    {
      type: "user",
      text: "Hi! Do you have availability tomorrow at 2pm?",
      delay: 0,
    },
    {
      type: "agent",
      text: "Hello! Let me check our availability for you.",
      delay: 1,
    },
    {
      type: "agent",
      text: "Yes! We have slots available tomorrow at 2:00 PM. Would you like to book an appointment?",
      delay: 2.5,
    },
    { type: "user", text: "Yes, please book it for Sarah Johnson", delay: 4 },
    {
      type: "agent",
      text: "✓ Perfect! I've booked your appointment for tomorrow at 2:00 PM under the name Sarah Johnson. You'll receive a confirmation via email shortly.",
      delay: 5,
    },
  ];
  ...
  return (
    ...
    >
      ...
      <section className="relative pt-20 pb-24 overflow-hidden">
        ...
        <div
          className="absolute bottom-20 right-10 w-96 h-96 bg-teal-300 rounded-full blur-3xl opacity-20 animate-pulse"
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <h3
                className="text-4xl lg:text-5xl mb-6 leading-[1.1] tracking-tight"
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Instant responses, seamless conversations, and automated
                workflows across WhatsApp, SMS, Email, and Webchat.
              </p>

              <div className="flex flex-wrap gap-4">
                <a
                  href="https://app.smbflow.ai/business/auth/signin"
                  target="_blank"
              ...
              <div className="grid grid-cols-3 gap-6 mt-12">
                {[
                  ...
                  <div key={i} className="text-center">
                    <div
                      className="text-3xl mb-1 bg-gradient-to-r from-purple-600 to-teal-600 bg-clip-text text-transparent"
                      style={{ fontFamily: "DM Sans, sans-serif" }}
                    >
                      {stat.value}
                    </div>
                ...
                <div className="p-5 space-y-4 bg-gradient-to-b from-gray-50 to-white min-h-[400px]">
                  ...
                  <div className="bg-white rounded-2xl rounded-tl-sm p-4 border border-gray-100">
                    <p className="text-gray-800 text-[15px] leading-relaxed">
                      ...
                      ready to help you with forms. How can I help you today?
                    </p>
                  </div>
            ...
            {[
              ...
              >
                ...
                <div className="relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
                  ...
                  <div
                    className={`w-14 h-14 bg-gradient-to-br ${step.color} rounded-xl flex items-center justify-center mb-4 shadow-lg`}
                  >
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Answer customer questions in under 1 second. No more waiting,
                  no more delays. Your customers get the information they need,
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Automatically qualify leads, schedule appointments, and
                  capture customer information without lifting a finger.
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  One agent, every channel. Deploy across WhatsApp, SMS, Email,
                  Instagram, Messenger, and Web Chat. Manage all conversations
                  in one place.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                <div
                  className={`w-12 h-12 bg-gradient-to-br ${benefit.color} rounded-xl flex items-center justify-center mb-4 shadow-md`}
                >
        ...
        <div className="max-w-5xl mx-auto px-8">
          ...
          >
            ...
            <div className="space-y-4 min-h-[300px]">
              {demoMessages
                .slice(0, Math.min(demoStep + 1, demoMessages.length))
                .map((msg, i) => (
                  <motion.div
                    key={i}
            ...
            {[
              {
                ...
                content:
                  "Our chat agent handles 90% of booking requests automatically. We went from spending 3 hours a day on messages to just checking confirmations. Game changer!",
                rating: 5,
              },
              {
                name: "James Chen",
                ...
                content:
                  "We get orders through WhatsApp 24/7 now. The chat agent never sleeps, never makes mistakes, and customers love the instant responses.",
                rating: 5,
              },
              {
                name: "Emily Thompson",
                ...
                content:
                  "Appointment reminders and rescheduling used to be a nightmare. Now our chat agent handles it all — patients can book, cancel, or reschedule on their own.",
                rating: 5,
              },
            ].map((testimonial, i) => (
              <motion.div
        ...
        <div className="max-w-5xl mx-auto px-8 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-10 leading-relaxed max-w-3xl mx-auto">
              Join thousands of businesses automating customer conversations
              with AI. Set up your first chat agent in under 10 minutes.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              >
                <Button
                  size="lg"
                  className="bg-white text-purple-700 hover:bg-gray-100 text-lg px-10 py-6 rounded-full shadow-2xl"
                >
                  Start Free
                  <ArrowRight className="w-5 h-5 ml-2" />
                </Button>
